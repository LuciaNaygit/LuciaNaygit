...
- 🛠 **Habilidades clave:**
  ...
  - Desarrollo de sistemas de información geográfica (SIG) para el monitoreo de seguridad con `QGIS` y `ArcGIS`.
  - Implementación de herramientas de ciberseguridad para proteger redes y datos sensibles.
- 🌐 **Proyectos destacados:**
  - **Plataforma de Monitoreo Ciudadano:** Desarrollé un sistema en tiempo real para reportes de incidentes, usando `React` y `Node.js`.
  - **Análisis de Tendencias Criminales:** Diseñé dashboards interactivos con `Tableau` y `Power BI` para visualización de datos de criminalidad.
...
- Implementación de **blockchain** para la seguridad de registros gubernamentales.
...
- **Red de Monitoreo en IoT:**  
  Sistema con sensores para detección de disparos en áreas de alta incidencia delictiva.
